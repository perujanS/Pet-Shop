...
import styles from "./EmailSubscriptionPopup.module.scss";
import Image from "next/image";
import { FaWhatsapp, FaFacebook, FaInstagram, FaYoutube } from "react-icons/fa";
import popupImage from "@/images/adorable-dog-with-owner-pet-shop (1)@2x.png"; // Use your actual image
            ...
            <Col md={8}>
              <div className={styles.content}>
                ...
                <Form className="m-0 p-0">
                  <Form.Group className={`${styles.fromG} mb-3 cols col-md-12`} controlId="formBasicEmail">
                    <Form.Control
                      type="email"
