...
import { Row , Col, Image, Button, Card, Stack } from "react-bootstrap";
    ...
    <div className="about-us container">
        ...
        <div className="about-home-main">
            ...
            <Col md={6} className="img-fluid mb-5 mb-md-0">
                <Image src={mainImg1.src} className="pe-1 pe-md-2 w-md-0 w-50 " alt="" />
                <Image src={mainImg2.src} className="ps-1 ps-md-2 w-md-0 w-50" alt="" />
            </Col>
            <Col md={5}>
                <h2 className="about-home-main-head">Welcome to Our Pet Shop</h2>
                <p className="mt-4 mb-5 about-home-main-para">At Our Pet Shop, we believe that pets are not just animals; they are beloved members of our families. Our passion for animals and commitment to their well-being drive everything we do.</p>
                <a className="about-home-btn" href="#">Read More</a>
            </Col>
            </Row>
        </div>
